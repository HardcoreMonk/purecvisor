...
def main() -> int:
    ...
    chapter_count = len(re.findall(r"^## \d+\. ", ui_guide, re.MULTILINE))
    require("DESIGN.md chapter count must match the UI guide", f"{chapter_count}개" in design)
    require("docs portal chapter count must match the UI guide", f"{chapter_count}개 장" in docs_html)
