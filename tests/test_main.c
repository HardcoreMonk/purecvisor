...
void test_rbac_totp_register(void);                                                                  
void test_network_register(void);                            
void test_vpc_model_register(void);                                               
void test_vpc_policy_register(void);                                              
void test_vpc_store_register(void);                                        
void test_vpc_rbac_register(void);                                              
...
void test_lio_register(void);                                                       
void test_iscsi_register(void);                                                       
...
void test_tenant_overlay_register(void);                                     
void test_tls_autogen_register(void);                                                    
void test_rest_transport_register(void);                                   
void test_rest_client_identity_register(void);                          
void test_bpf_manifest_register(void);                                         
void test_bpf_integration_register(void);                                                            
void test_shared_bridge_integration_register(void);                                              
void test_qos_register(void);                                                             
void test_qos_chaos_register(void);                                                                  
void test_qos_integration_register(void);                                                           
...
void test_suricata_integration_register(void);                                                                             
extern void test_undefine_debounce_register(void);                                         
void test_secure_register(void);                                                        
void test_vm_death_class_register(void);                                   
void test_cgroup_psi_register(void);                                              
void test_anomaly_autowatch_register(void);                                                   
...
int main(int argc, char *argv[]) {
    ...
    test_jwt_register();                                 
    test_totp_register();                                    
    test_rbac_totp_register();                              
    test_network_register();                            
    test_vpc_model_register();                                 
    test_vpc_policy_register();                                 
    test_vpc_store_register();                                     
    test_vpc_rbac_register();                                          
    ...
    test_tenant_overlay_register();                                                       
    test_tls_autogen_register();                                                    
    test_rest_transport_register();                                   
    test_rest_client_identity_register();                          
    test_bpf_manifest_register();                                         
    test_bpf_integration_register();                                                            
    test_shared_bridge_integration_register();                                         
    test_qos_register();                                                             
    test_qos_chaos_register();                                                                  
    ...
    test_suricata_integration_register();                                                                             
    test_undefine_debounce_register();                                          
    test_secure_register();                                                       
    test_vm_death_class_register();                                   
    test_cgroup_psi_register();                                              
    test_anomaly_autowatch_register();                                                   
    ...
    test_hotplug_nic_xml_register();                                                        
    test_audit_chain_register();                                                       
    test_webpush_crypto_register();                                                           
    test_webpush_register();                                                         
    test_dpdk_register();                                                   
