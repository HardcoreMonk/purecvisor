...
var I18N = {
  ...
  _data: {
    ko: {
      ...
      'login.totp.title': 'TOTP 인증',
      'login.totp.prompt': '인증 앱의 6자리 코드 입력',
      'login.totp.recovery_link': '복구코드 사용',
      'login.totp.invalid': '코드가 올바르지 않습니다',
      'login.totp.locked': '시도 초과 — 잠시 후 재시도',
      'login.totp.expired': '세션 만료 — 다시 로그인',
      'logged.in': '로그인 완료',
      'logged.out': '로그아웃 완료',
      ...
      'totp.enroll.title': 'TOTP 등록',
      'totp.enroll.scan': '인증 앱으로 스캔하거나 키를 직접 입력',
      'totp.enroll.confirm': '앱의 코드로 확정',
      'totp.recovery.title': '복구코드',
      'totp.recovery.notice': '지금 1회만 표시됩니다 — 안전한 곳에 보관',
      'totp.recovery.saved': '저장했습니다',
      'totp.settings.title': '2단계 인증 (TOTP)',
      'totp.settings.enabled': '활성',
      'totp.settings.disabled': '비활성',
      'totp.settings.enable': '활성화',
      'totp.settings.disable': '해제',
      'totp.settings.regen': '복구코드 재발급',
      'totp.settings.reset': 'TOTP 리셋',
      'totp.settings.remaining': '잔여 복구코드',
    ...
    en: {
      ...
      'login.tls.insecure': 'Unsecured Connection',
      'login.tls.switch': 'Switch to HTTPS',
      'login.totp.title': 'TOTP verification',
      'login.totp.prompt': 'Enter the 6-digit code',
      'login.totp.recovery_link': 'Use recovery code',
      'login.totp.invalid': 'Invalid code',
      'login.totp.locked': 'Too many attempts',
      'login.totp.expired': 'Expired — log in again',
      'logged.in': 'Logged in',
      ...
      'totp.enroll.title': 'Enroll TOTP',
      'totp.enroll.scan': 'Scan or enter key manually',
      'totp.enroll.confirm': 'Confirm with app code',
      'totp.recovery.title': 'Recovery codes',
      'totp.recovery.notice': 'Shown only once — store safely',
      'totp.recovery.saved': 'I saved them',
      'totp.settings.title': 'Two-factor (TOTP)',
      'totp.settings.enabled': 'Enabled',
      'totp.settings.disabled': 'Disabled',
      'totp.settings.enable': 'Enable',
      'totp.settings.disable': 'Disable',
      'totp.settings.regen': 'Regenerate codes',
      'totp.settings.reset': 'Reset TOTP',
      'totp.settings.remaining': 'Recovery codes left',
