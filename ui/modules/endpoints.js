...
var EP = (function() {
  ...
  var COMMON_ENDPOINTS = {
    ...
    VPC_STATUS:           function()     { return B() + '/vpcs/status'; },
    VPC_BACKENDS:         function()     { return B() + '/vpcs/backends'; },
    VPC_DETAIL:           function(id)   { return B() + '/vpcs/' + enc(id); },
    VPC_EGRESS:           function(id)   { return B() + '/vpcs/' + enc(id) + '/egress'; },
    VPC_SUBNETS:          function(id)   { return B() + '/vpcs/' + enc(id) + '/subnets'; },
    VPC_SUBNET:           function(id)   { return B() + '/vpc-subnets/' + enc(id); },
    VPC_ATTACHMENTS:      function(id)   { return B() + '/vpcs/' + enc(id) + '/attachments'; },
    VPC_ATTACHMENT_LIST:  function()     { return B() + '/vpc-attachments'; },
    VPC_ATTACHMENT:       function(id)   { return B() + '/vpc-attachments/' + enc(id); },
    VPC_SERVICES:         function(id)   { return B() + '/vpcs/' + enc(id) + '/services'; },
    VPC_SERVICE_LIST:     function()     { return B() + '/vpc-services'; },
    VPC_SERVICE:          function(id)   { return B() + '/vpc-services/' + enc(id); },
    VPC_RECONCILE:        function()     { return B() + '/vpcs/reconcile'; },
    ...
    AUTH_TOTP_VERIFY:     function()     { return B() + '/auth/totp/verify'; },
    AUTH_TOTP_ENROLL:     function()     { return B() + '/auth/totp/enroll'; },
    AUTH_TOTP_STATUS:     function()     { return B() + '/auth/totp/status'; },
    AUTH_TOTP_DISABLE:    function()     { return B() + '/auth/totp/disable'; },
    AUTH_TOTP_RESET:      function()     { return B() + '/auth/totp/reset'; },
    AUTH_TOTP_RECOVERY:   function()     { return B() + '/auth/totp/recovery/regenerate'; },
    ...
    SURICATA_STATUS:      function()     { return B() + '/suricata/status'; },
    SURICATA_POLICY:      function()     { return B() + '/suricata/policy'; },
    SURICATA_RULES_UPDATE:function()     { return B() + '/suricata/rules/update'; },
    SURICATA_IPS_STATUS:  function()     { return B() + '/suricata/ips/status'; },
    SURICATA_IPS_ENABLE:  function()     { return B() + '/suricata/ips/enable'; },
    SURICATA_IPS_DISABLE: function()     { return B() + '/suricata/ips/disable'; },
    SURICATA_IPS_DROP:    function()     { return B() + '/suricata/ips/drop'; },
    ...
    PUSH_VAPID:           function()     { return B() + '/push/vapid'; },
    PUSH_SUBSCRIBE:       function()     { return B() + '/push/subscribe'; },
    PUSH_UNSUBSCRIBE:     function()     { return B() + '/push/unsubscribe'; },
                                                     
                                                   
    PUSH_MINE:            function()     { return B() + '/push/mine'; },
    ...
    WEBHOOK_DLQ_RETRY:    function()     { return B() + '/webhook/dlq/retry'; },
