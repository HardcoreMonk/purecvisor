...
| ADR-0046 | Approved | 공개 landing은 Astro·Starlight로 build하고 `/docs.html`은 같은 공개 릴리스의 제품 `ui/docs.html`·`ui/guide-content.md`를 게시한다. `https://purecvisor.site/docs.html`을 안정 URL로 유지하고 `guide.html`은 사용하지 않는다. |
