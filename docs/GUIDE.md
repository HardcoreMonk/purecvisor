...
> **문서 지도**: 설치와 운영은 이 문서, 시각 규격은 루트 [DESIGN.md](../DESIGN.md), 공개판 경계는 [PUBLIC_RELEASE_BOUNDARY.md](PUBLIC_RELEASE_BOUNDARY.md), 설계 결정은 [ADR_INDEX.md](ADR_INDEX.md)와 `docs/adr/`를 기준으로 봅니다.
