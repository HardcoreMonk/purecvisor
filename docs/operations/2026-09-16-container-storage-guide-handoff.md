...
> 기준일: 2026-09-16 KST
> 문서 상태: 공개 게시·확인 완료
> 당시 Btrfs 백엔드 상태: 조사 완료 · 구현 전 제안
> 후속 상태: `e028ef2`에서 선택형 Btrfs 구현·지정 API 실기를 완료했다.
> 아래 ZFS 필수·미지원·다음 작업 표현은 `ca057bd` 당시 기록이며, 현재 계약은
> [가이드 4.1절](../GUIDE.md#41-컨테이너-생성)과 [Btrfs API 인계](2026-09-16-lxc-btrfs-api-validation.md)를 따른다.
