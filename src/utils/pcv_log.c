                 ...
                 gpointer        user_data __attribute__((unused)))
{
    ...
    gchar *msg_esc = pcv_json_escape(message);
    gchar *dom_esc = pcv_json_escape(dom);
    gchar *req_esc = pcv_json_escape(req);
               ...
               ...)
{
    ...
    gchar *msg_esc = pcv_json_escape(msg);
    gchar *dom_esc = pcv_json_escape(domain   ? domain    : "purecvisor");
    gchar *op_esc  = pcv_json_escape(operation ? operation : "unknown");
    gchar *tgt_esc = pcv_json_escape(target   ? target    : "-");
    gchar *req_esc = pcv_json_escape(req);
