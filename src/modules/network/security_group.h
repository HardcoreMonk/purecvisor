...
void       pcv_security_group_unbind_vm_all(const gchar *vm);                                       
                                                
void       pcv_security_group_sync_vm(const gchar *vm_name);                                    
gboolean   pcv_security_group_vm_is_bound(const gchar *vm);                                       
                                                                        
                                                                                           
JsonObject *pcv_security_group_policy_for_vm(const gchar *vm);
                                                
void       pcv_security_group_restore(void);
void       pcv_security_group_overlay_exclusion_audit(void);                            
