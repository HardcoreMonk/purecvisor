...
static const PcvSecurityStringMap k_sources[] = {
    ...
    { PCV_SECURITY_SOURCE_LSM, "lsm" },
                                                                                     
    { PCV_SECURITY_SOURCE_SURICATA, "suricata" },
};
...
static const PcvSecurityStringMap k_types[] = {
    ...
    { PCV_SECURITY_EVENT_FILE_ACCESS_SENSITIVE, "file_access_sensitive" },                                                   
                                                                                 
                                                                       
    { PCV_SECURITY_EVENT_NETWORK_THREAT, "network_threat" },
};
