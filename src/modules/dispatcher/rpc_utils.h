...
typedef enum {
    ...
    PURE_RPC_ERR_TOTP_REQUIRED        = -32007,
                                                                 
    PURE_RPC_ERR_TOTP_ENROLL_REQUIRED = -32008,
                            
    PURE_RPC_ERR_TOTP_INVALID_CODE    = -32009,
                                                         
    PURE_RPC_ERR_TOTP_PENDING_EXPIRED = -32010,
                                                   
    PURE_RPC_ERR_TOTP_LOCKED          = -32011
} PureRpcErrorCode;
